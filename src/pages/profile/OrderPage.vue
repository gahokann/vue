<template lang="">
    <div class="index__profile">
        <div class="user__table__admin allOrderPage">
            ...
            <div class="order__block">
                <div class="order__block__info__items">
                    <div class="order__block__info__item">
                        ...
                        <p @click="setCompany(getOrderUser.company), isModalInfoCompany.active = !isModalInfoCompany.active" class="order__block__info__company">
                            Компания: {{ getOrderUser.company_name }}
                        </p>
                    </div>
                        <div class="order__block__info__item">
                            <div @click="setPerson(getOrderUser.employee), isModalInfoEmployeeOpen.active = !isModalInfoEmployeeOpen.active" class="sotr">
                                <h4 class="info__item__sotr">Сотрудник</h4>
                                <div class="info__item__fio">
                                    <p v-if="getOrderUser.employee_id != null">
                                        {{ `${getOrderUser.employee.firstName} ${getOrderUser.employee.secondName} ${getOrderUser.employee.lastName}` }}
                                    </p>
                                    <p v-if="getOrderUser.employee_id == null">Сотрудник не назначен</p>
                                    
                                </div>
                            </div>
                            <img @click="setPerson(getOrderUser.employee), isModalInfoEmployeeOpen.active = !isModalInfoEmployeeOpen.active" src="../../assets/img/1.jpg" alt="" class="info__item__img">
                            <a @click="setOrder(getOrderUser), isModalChangeOpen.active = !isModalChangeOpen.active" class="btn__settings__order">
            ...
            <ModalChangeOrder :class="isModalChangeOpen" @close="isModalChangeOpen.active = false" :orderNumber=order.id
...
export default {
    ...
    computed: {
        ...mapGetters(['getOrderUser', 'getStatus'])
    },
    methods: {
