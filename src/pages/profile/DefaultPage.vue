<template lang="">
    <div class="page">
        <nav class="nav__profile__items">
            <router-link :to="{ name: 'main' }" class="nav__profile__title__link">
                <div class="nav__profile__item">
                    <img src="../../assets/img/logo.png" alt="" class="nav__profile__logo">
                    <p class="nav__profile__title">Первая Снабженческая Компания</p>
                </div>
            </router-link>
            <div class="nav__profile__item">
                <router-link :to="{name: 'profileMain'}" class="nav__profile__item__link">
                    <div class="nav__profile__info">
                        <img src="../../assets/img/1.jpg" alt="" class="profile__info__logo">
                        <div class="profile__info__fio-company">
                        <p class="profile__info__fio">Демошенков Сергей Михайлович</p>
                        <p class="profile__info__company">ООО "ПСК"</p> 
                        </div>
                    </div>
                </router-link>
  ...
  <path fill-rule="evenodd" d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 0v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0v2z" fill="#f00"/>
  <path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z" fill="#f00"/>
                    </svg>
                </div>
            </div>
        ...
        <sidebar class="sidebar__profile" :class="burgerProfile">
            ...
            <div @click="burgerProfile.active = !burgerProfile.active" id="burger__profile" class="sidebar__profile__burger" :class="burgerProfile">
                <span></span>
            </div>
            ...
            <nav class="sidebar__profile__nav nav__mobile">
                ...
                <router-link :to="{ name: 'profileMain' }" class="sidebar__profile__nav__link">
...
<path d="M46.501,0H8.499C4.088,0,0.5,3.587,0.5,7.997v39.006C0.5,51.413,4.088,55,8.499,55h38.002
    ...
    C5.191,53,2.5,50.31,2.5,47.003V7.997C2.5,4.69,5.191,2,8.499,2h38.002C49.809,2,52.5,4.69,52.5,7.997V47.003z"></path>
<path d="M28.207,8.293c-0.391-0.391-1.023-0.391-1.414,0l-16,16c-0.286,0.286-0.372,0.716-0.217,1.09
    ...
    c-0.553,0-1,0.448-1,1v12h-6V26h22V43z M39.5,24h-24h-1.586L27.5,10.414L41.086,24H39.5z"></path>
</g>
</g>
<g>
</g>
...
<g>
                ...
                <router-link :to="{ name: 'profileSettings' }" class="sidebar__profile__nav__link">
  ...
  <path d="M9.796 1.343c-.527-1.79-3.065-1.79-3.592 0l-.094.319a.873.873 0 0 1-1.255.52l-.292-.16c-1.64-.892-3.433.902-2.54 2.541l.159.292a.873.873 0 0 1-.52 1.255l-.319.094c-1.79.527-1.79 3.065 0 3.592l.319.094a.873.873 0 0 1 .52 1.255l-.16.292c-.892 1.64.901 3.434 2.541 2.54l.292-.159a.873.873 0 0 1 1.255.52l.094.319c.527 1.79 3.065 1.79 3.592 0l.094-.319a.873.873 0 0 1 1.255-.52l.292.16c1.64.893 3.434-.902 2.54-2.541l-.159-.292a.873.873 0 0 1 .52-1.255l.319-.094c1.79-.527 1.79-3.065 0-3.592l-.319-.094a.873.873 0 0 1-.52-1.255l.16-.292c.893-1.64-.902-3.433-2.541-2.54l-.292.159a.873.873 0 0 1-1.255-.52l-.094-.319zm-2.633.283c.246-.835 1.428-.835 1.674 0l.094.319a1.873 1.873 0 0 0 2.693 1.115l.291-.16c.764-.415 1.6.42 1.184 1.185l-.159.292a1.873 1.873 0 0 0 1.116 2.692l.318.094c.835.246.835 1.428 0 1.674l-.319.094a1.873 1.873 0 0 0-1.115 2.693l.16.291c.415.764-.42 1.6-1.185 1.184l-.291-.159a1.873 1.873 0 0 0-2.693 1.116l-.094.318c-.246.835-1.428.835-1.674 0l-.094-.319a1.873 1.873 0 0 0-2.692-1.115l-.292.16c-.764.415-1.6-.42-1.184-1.185l.159-.291A1.873 1.873 0 0 0 1.945 8.93l-.319-.094c-.835-.246-.835-1.428 0-1.674l.319-.094A1.873 1.873 0 0 0 3.06 4.377l-.16-.292c-.415-.764.42-1.6 1.185-1.184l.292.159a1.873 1.873 0 0 0 2.692-1.115l.094-.319z"/>
                    ...
                    <p class="sidebar__profile__nav__link__text">Настройки</p>
                </router-link>
                <router-link :to="{ name: 'profileCompany' }" class="sidebar__profile__nav__link">
  ...
  <path fill-rule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm-3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
                ...
                <a href="#" class="sidebar__profile__nav__link">
  ...
  <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4Zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10Z"/>
                    ...
                    <p class="sidebar__profile__nav__link__text">Пользователи</p>
                </a>
                <a href="#" class="sidebar__profile__nav__link ">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
  <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4Zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10Z"/>
</svg>
                    <p class="sidebar__profile__nav__link__text">Сотрудники</p>
                </a>
                <a href="#" class="sidebar__profile__nav__link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-ul" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm-3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
  ...
  <path d="M2 1a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V1Zm11 0H3v14h3v-2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V15h3V1Z"/>
                    ...
                    <p class="sidebar__profile__nav__link__text">Компании</p>
                </a>
                <a href="#" class="sidebar__profile__nav__link">
